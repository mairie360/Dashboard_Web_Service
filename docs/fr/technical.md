...
Documentation du code versionné au 7 septembre 2026, basée sur `a9bdfa9eb7bc`. Les commandes ci-dessous décrivent les vérifications à effectuer; elles ne certifient pas un déploiement distant.
